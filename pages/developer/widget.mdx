...
The Metastore Widget allows the users to connect with their Metastore account and choose their game item to play with.
...
The Metastore Widget is a web iframe that you can direcly call from your website.
